...
__all__ = ('main', 'ConfigurationEditor')
...
class ConfigurationEditor(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent: Optional[QtWidgets.QWidget] = None) -> None:
        ...
        new_icon = QtGui.QIcon(':/icons/document-new')
        ...
        select_icon = QtGui.QIcon(':/icons/configure')
