...
class LorentzianLinear(FitModelBase):
    ...
    def estimate_peak(self, data, x):
        ...
        offset = (
            linear_fit.params["offset"].value
            + min(x) * linear_fit.params["slope"].value
        )
        ...
        estimate["slope"].set(
            value=linear_fit.params["slope"].value, min=-np.inf, max=np.inf, vary=True
        )
        estimate["amplitude"].set(
            value=gauss_fit.params["amplitude"].value,
            min=gauss_fit.params["amplitude"].min,
            max=gauss_fit.params["amplitude"].max,
            vary=True,
        )
        estimate["center"].set(
            value=gauss_fit.params["center"].value,
            min=gauss_fit.params["center"].min,
            max=gauss_fit.params["center"].max,
            vary=True,
        )
        estimate["sigma"].set(
            value=gauss_fit.params["sigma"].value,
