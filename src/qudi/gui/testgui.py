...
class TestGui(GuiBase):
    ...
    def on_activate(self) -> None:
        ...
        y3 = 3 * np.sin(3*x)
        y4 = 4 * np.sin(4*x)
        self._mw.test_widget.plot(x=x, y=y1, name='my plot', pen='r')
        self._mw.test_widget.plot(x=x, y=y2, name='my other plot', pen='b')
        self._mw.test_widget.plot(x=x, y=y3, name='not mine', pen='c')
        self._mw.test_widget.plot(x=x, y=y4, name='dfajdbhfösfdigbhuuf', pen='g')
